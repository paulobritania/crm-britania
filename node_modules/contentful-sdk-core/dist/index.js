...
var rateLimitThrottle = (function (axiosInstance) {
  ...
  var _axiosInstance$defaul = axiosInstance.defaults.logHandler,
      logHandler = _axiosInstance$defaul === void 0 ? lodash.noop : _axiosInstance$defaul;
  var limit = lodash.isString(type) ? calculateLimit(type) : calculateLimit('auto', type);
  ...
  var responseInterceptorId = axiosInstance.interceptors.response.use(function (response) {
    if (!isCalculated && lodash.isString(type) && (type === 'auto' || PERCENTAGE_REGEX.test(type)) && response.headers && response.headers['x-contentful-ratelimit-second-limit']) {
...
function rateLimit(instance) {
  ...
  var _instance$defaults = instance.defaults,
      ...
      responseLogger = _instance$defaults$re === void 0 ? lodash.noop : _instance$defaults$re,
      _instance$defaults$re2 = _instance$defaults.requestLogger,
      requestLogger = _instance$defaults$re2 === void 0 ? lodash.noop : _instance$defaults$re2;
